        ...
        <div className="bg-white rounded-lg shadow-lg overflow-hidden">
          ...
          <div className="p-5 bg-white border-b border-gray-200">
            <div className="flex justify-between items-center">
              ...
              <Link
                to="/add"
                className="flex items-center gap-1 px-4 py-2 bg-emerald-500 text-white rounded-md hover:bg-emerald-600 transition-colors duration-200"
              >
                      ...
                      <td className="px-6 py-4 text-sm font-medium text-center">
                        <div className="flex justify-center space-x-2">
                          ...
                          >
                            <Edit
                              size={14}
                              className="mr-1 group-hover:text-blue-800"
                            />
                            <span>Edit</span>
                          </Link>
                          <button
                          ...
                          >
                            <Trash2
                              size={14}
                              className="mr-1 group-hover:text-red-800"
                            />
                            <span>Delete</span>
                          </button>
                        </div>
